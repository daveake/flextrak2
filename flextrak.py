...
class Tracker(object):
    ...
    def LoadSettings(self, filename):
        if os.path.isfile(filename):
            ...
            self.Settings_Prediction_PayloadWeight = config.getfloat('Prediction', 'PayloadWeight')
    ...
    def SendSettings(self):
        ...
        # OnBoard Prediction Settings
        # self.avr.AddCommand('PL' + str(self.Settings_Prediction_LandingAltitude))
        self.avr.AddCommand('PC' + str(self.Settings_Prediction_DefaultCDA))
        self.avr.AddCommand('PW' + str(self.Settings_Prediction_PayloadWeight))       

        # Cutdown Settings
        self.avr.AddCommand('CA' + str(self.Settings_Cutdown_Altitude))
